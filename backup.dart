...
// // //     isOpen = List.generate(10, (index) => false);
// // //     Future.microtask(() {
// // //       Provider.of<AuthServices>(context, listen: false).getUserVirtualAccounts();
// // //     });
// // //   }
...
// // //                         )
// // //                       : ListView.builder(
// // //                           itemCount: auth.userVirtualAccounts.length,
// // //                           itemBuilder: (context, index) {
// // //                             var session = auth.userVirtualAccounts[index];
...
// // //                                                 Text(
// // //                                                   "Created Date: ${session.lastLoginTime}",
// // //                                                   style: GoogleFonts.inter(
// // //                                                     fontSize: 14,
// // //                                                     color: Theme.of(context).textTheme.bodyLarge?.color,
// // //                                                   ),
...
// // //                                           CustomPaint(
// // //                                             size: const Size(
// // //                                                 60, 45), // Adjust the size to best match your design
